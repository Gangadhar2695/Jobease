...
const LocationSort = () => {
  ...
  const filteredData = data.filter(item => item.Location.toLowerCase() === locations.toLowerCase());
  ...
  return (
    <>
      <div className="jobcategory  d-flex flex-column flex-wrap  rounded-2 bg-light gap-5">

        <div className='jobcategoryOne d-flex flex-row  mt-3 align-items-center flex-wrap container  justify-content-center '>
          <div ><h4 className="col-6-lg remote-header"><marquee width="100%" direction="left" scrollamount="10" > JOBS IN {locations}</marquee></h4></div>
        ...
        <div className=" m-5 d-flex flex-column gap-5 sidebar">
