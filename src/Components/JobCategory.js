    ...
    <>
      <div className=" jobcategory d-flex flex-column flex-wrap gap-5 rounded-2">
        ...
        <div className='jobcategoryOne mt-3 d-flex flex-row align-items-center flex-wrap container justify-content-center  '>
          <div ><h4 className="remote-header col-6-lg"><marquee width="100%" direction="left" scrollamount="10" >{category} JOBS IN INDIA</marquee></h4></div>
        ...
        <div className='d-flex flex-row flex-wrap jobcategory-two'>
          ...
          <div className='d-flex flex-column p-2 offcampus'>

            {(searchItems ? filteredJobs : currentItems).map((item) => (
              <div className="card cards mb-3" key={item.Url}>
                <div className="card-body">
                  <div className="d-flex flex-row justify-content-between m-1 gap-4">
          ...
          <div className=" m-4 d-flex flex-column gap-5 sidebar">
      ...
      <div className='w-100 d-flex justify-content-center my-5 p-3'>
        <JobsByCategory />
      </div>
    </>
  )
